...
var dialog_7  = "[center]Your score is shown here, at the end of the lvl it's will be converted to [color=yellow]COINS[/color]. ([color=green]DIFFICULTY[/color] will change the amount of [color=YELLOW]COINS[/color] earned in each lvl.)[/center]"
var dialog_8  = "[center]When this barr become full and [color=green]GREEN[/color], it's mean you may be able to pass to [color=red]NEXT LVL[/color].[/center]"
var dialog_9  = "[center]Use [color=green]LEFT CLICK[/color] to [color=yellow]move[/color] the camera, and the [color=green]SCROLL WHEEL[/color] to [color=yellow]ZOOM[/color] in or out or [color=green]SCROLL BUTTON[/color] to [color=yellow]rotate[/color] the view."
var dialog_10 = "[center]Prepare your [color=green]ARMY[/color]."
var dialog_11 = "[center]Your [color=green]CURRENT LVL[/color], beats the level to [color=yellow]UNLOCK[/color] the next one"
