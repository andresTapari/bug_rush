...
var bar_red = preload("res://assets/texture/health_barr/barHorizontal_green_mid 200.png")
var bar_green = preload("res://assets/texture/health_barr/barHorizontal_red_mid 200.png")
